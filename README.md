...
- 📋 **Frameworks ISO** — programas de implementação com controles reais, evidências, maturidade e **gerador de planos com IA** para as normas 27001, 27002, 27017, **27701**, **22301 (BCM)**, 31000, 37001 e 37301 — com **anexos de evidências (documentos e imagens)** em cada controle e **geração de políticas/documentos em PDF** (capa, sumário, 2 políticas por norma, anexo de evidências e bloco de aprovação; CONTROLADO com 60%+, RASCUNHO com marca d'água antes);
- 📥 **Importação de planilhas** — alimente o mapeamento LGPD (art. 37) e o ROPA GDPR (art. 30) importando CSV, com modelo para download; a **matriz de risco recalcula automaticamente** a cada inclusão;
