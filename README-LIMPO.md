...
4. O workflow `.github/workflows/deploy.yml` será executado automaticamente a cada push
5. O site será publicado em: `https://seu-usuario.github.io/nome-do-repositorio`
...
- [SOLUCAO-VERCEL.md](./SOLUCAO-VERCEL.md) - Solução para problemas com Vercel
