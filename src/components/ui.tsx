...
const PATHS: Record<string, ReactNode> = {
  radar: (<><circle cx="12" cy="12" r="9" /><circle cx="12" cy="12" r="4.5" /><path d="M12 12 18.5 5.8" /><circle cx="12" cy="12" r="0.8" fill="currentColor" stroke="none" /></>),
  ...
  spark: (<><path d="M12 3.5c.6 3.9 2.6 5.9 6.5 6.5-3.9.6-5.9 2.6-6.5 6.5-.6-3.9-2.6-5.9-6.5-6.5 3.9-.6 5.9-2.6 6.5-6.5Z" /><path d="M18.8 15.5c.3 1.8 1.2 2.7 3 3-1.8.3-2.7 1.2-3 3-.3-1.8-1.2-2.7-3-3 1.8-.3 2.7-1.2 3-3Z" /></>),
  layers: (<><path d="m12 3 9 5-9 5-9-5 9-5Z" /><path d="m3.5 12.5 8.5 4.7 8.5-4.7" /><path d="m3.5 16.5 8.5 4.7 8.5-4.7" /></>),
  matrix: (<><path d="M4 20V4" /><path d="M4 20h16" /><circle cx="10" cy="14" r="1.4" /><circle cx="15" cy="9" r="1.4" /><circle cx="18" cy="6" r="1.4" /></>),
  scale: (<><path d="M12 4v16M8 20h8" /><path d="M5 7h14" /><path d="m6.5 7-2.8 6a3 3 0 0 0 5.6 0L6.5 7Z" /><path d="m17.5 7-2.8 6a3 3 0 0 0 5.6 0l-2.8-6Z" /></>),
  doc: (<><path d="M6 3h8l4 4v14H6V3Z" /><path d="M14 3v4h4" /><path d="M9 12h6M9 15.5h6" /></>),
  plus: <path d="M12 5v14M5 12h14" />,
  x: <path d="m6 6 12 12M18 6 6 18" />,
  check: <path d="m4.5 12.5 5 5L19.5 7" />,
  alert: (<><path d="M12 3.5 22 20H2L12 3.5Z" /><path d="M12 10v4.5" /><circle cx="12" cy="17.3" r="0.7" fill="currentColor" stroke="none" /></>),
  search: (<><circle cx="11" cy="11" r="6.5" /><path d="m16 16 5 5" /></>),
  download: (<><path d="M12 4v11" /><path d="m7 10.5 5 5 5-5" /><path d="M4.5 20h15" /></>),
  printer: (<><path d="M7 8V3.5h10V8" /><rect x="4" y="8" width="16" height="8" rx="1.5" /><path d="M7 13.5h10v7H7v-7Z" /></>),
  trash: (<><path d="M4.5 6.5h15" /><path d="M9 6V4h6v2" /><path d="M6.5 6.5 7.5 21h9l1-14.5" /><path d="M10 10.5v6M14 10.5v6" /></>),
  ...
  user: (<><circle cx="12" cy="8" r="3.8" /><path d="M4.5 20.5c1.2-3.6 4-5.4 7.5-5.4s6.3 1.8 7.5 5.4" /></>),
  send: <path d="m4 11 16-7-5.5 16-2.5-6.5L4 11Z" />,
  wand: (<><path d="m5 19 9.5-9.5" /><path d="M15.5 3.8c.3 1.7 1.2 2.6 2.9 2.9-1.7.3-2.6 1.2-2.9 2.9-.3-1.7-1.2-2.6-2.9-2.9 1.7-.3 2.6-1.2 2.9-2.9Z" /><path d="m5.5 4.5 1 2 2 1-2 1-1 2-1-2-2-1 2-1 1-2Z" /></>),
  globe: (<><circle cx="12" cy="12" r="8.5" /><path d="M3.5 12h17M12 3.5c2.6 2.4 3.9 5.1 3.9 8.5S14.6 18.1 12 20.5C9.4 18.1 8.1 15.4 8.1 12S9.4 5.9 12 3.5Z" /></>),
  shield: (<><path d="M12 3 20 6v6c0 4.8-3.2 7.9-8 9.5C7.2 19.9 4 16.8 4 12V6l8-3Z" /><path d="m8.7 12 2.3 2.3 4.3-4.6" /></>),
  ...
  brain: (<><path d="M9.5 4A2.7 2.7 0 0 0 6.8 6.8 3.2 3.2 0 0 0 4 10c0 .9.3 1.7.9 2.3A3.2 3.2 0 0 0 6 18c.3 1.2 1.4 2 2.6 2 .8 0 1.5-.3 2-.8V6.6a2.7 2.7 0 0 0-1.1-2.6Z" /><path d="M14.5 4a2.7 2.7 0 0 1 2.7 2.8A3.2 3.2 0 0 1 20 10c0 .9-.3 1.7-.9 2.3A3.2 3.2 0 0 1 18 18c-.3 1.2-1.4 2-2.6 2-.8 0-1.5-.3-2-.8V6.6A2.7 2.7 0 0 1 14.5 4Z" /></>),
  ...
  lock: (<><rect x="5" y="10.5" width="14" height="9.5" rx="1.5" /><path d="M8 10.5V7.5a4 4 0 0 1 8 0v3" /><circle cx="12" cy="15" r="1.2" fill="currentColor" stroke="none" /></>),
  key: (<><circle cx="8" cy="14.5" r="3.5" /><path d="m10.8 12 8.7-8.5" /><path d="m16.5 6.5 2.5 2.5M14 9l2 2" /></>),
...
export function Ring({ value, size = 148, stroke = 11, cor = "var(--color-moss)" }: { value: number; size?: number; stroke?: number; cor?: string }) {
  ...
  return (
    <svg width={size} height={size} className="block">
      ...
      <circle cx={size / 2} cy={size / 2} r={r} fill="none" stroke={cor} strokeWidth={stroke} strokeLinecap="round" strokeDasharray={c} strokeDashoffset={off} transform={`rotate(-90 ${size / 2} ${size / 2})`} style={{ transition: "stroke-dashoffset 1.1s cubic-bezier(0.22,1,0.36,1)" }} />
    </svg>
  );
}
...
export function ChipToggle({ ativo, onClick, children, sensivel = false }: { ativo: boolean; onClick: () => void; children: ReactNode; sensivel?: boolean }) {
  return (
    <button type="button" onClick={onClick} className={`inline-flex items-center gap-1.5 rounded-md border px-2.5 py-1.5 text-left text-[12.5px] leading-tight transition-all duration-150 ${ativo ? (sensivel ? "border-rust bg-rust text-cream shadow-sm" : "border-pine bg-pine text-lime shadow-sm") : sensivel ? "border-rust/40 bg-rust-soft/30 text-rust hover:border-rust/70" : "border-sand bg-cream text-ink-soft hover:border-moss hover:text-ink"}`}>
  ...
  return (
    <div className="mt-1.5">
      <div className="flex gap-1">
        {[0, 1, 2, 3].map((i) => (
          <span key={i} className="h-1.5 flex-1 rounded-full bg-paper-deep transition-colors duration-300" style={senha && i < f.score ? { background: f.cor } : undefined} />
        ))}
      </div>
      {senha && (
        <p className="mt-1 text-[10.5px] font-bold tracking-wide uppercase" style={{ color: f.cor }}>
          {f.label} · mínimo de 10 caracteres
        </p>
      )}
    </div>
  );
...
/* ================= Tela de desbloqueio (paywall por plano) ================= */

export function Bloqueado({ titulo, recursos, onUpgrade }: { titulo: string; recursos?: string[]; onUpgrade: () => void }) {
  return (
    <div className="anim-rise mx-auto max-w-xl rounded-xl border border-sand bg-cream p-8 text-center">
      <span className="mx-auto grid size-16 place-items-center rounded-2xl bg-pine text-lime">
        <Ic name="lock" size={30} sw={1.7} />
      </span>
      <h2 className="font-display mt-5 text-[24px] font-extrabold tracking-tight text-ink">{titulo}</h2>
      <p className="mt-2 text-[13.5px] leading-relaxed text-ink-soft">
        Este módulo faz parte dos planos pagos. Assine dentro do sistema para liberar na hora.
      </p>
      {recursos && recursos.length > 0 && (
        <ul className="mx-auto mt-5 max-w-sm space-y-2 text-left">
          {recursos.map((r) => (
            <li key={r} className="flex items-start gap-2 text-[13px] text-ink-soft">
              <span className="mt-0.5 grid size-4.5 shrink-0 place-items-center rounded-full bg-moss/12 text-moss"><Ic name="check" size={10} sw={3} /></span>
              {r}
            </li>
          ))}
        </ul>
      )}
      <button onClick={onUpgrade} className="group mt-6 inline-flex items-center gap-2 rounded-md bg-pine px-6 py-3 text-[14px] font-bold text-lime shadow-sm transition hover:bg-pine-deep active:scale-[0.98]">
        <Ic name="star" size={15} sw={2.2} /> Ver planos e desbloquear
...
export function ToastHost() {
  ...
  return (
    <div className="pointer-events-none fixed right-5 bottom-5 z-[60] flex w-80 flex-col gap-2">
      {toasts.map((t) => (
        <div key={t.id} className={`toast-in pointer-events-auto flex items-start gap-2.5 rounded-lg border px-3.5 py-3 shadow-lg ${t.tom === "ia" ? "border-pine-line bg-pine text-lime" : t.tom === "warn" ? "border-amber/50 bg-amber-soft text-ink" : "border-moss/40 bg-cream text-ink"}`}>
